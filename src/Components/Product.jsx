...
function Product(props) {
  ...
  const addToCart = (item) => {
    setCart((prevItems) => {
      ...
      if (itemExists) {
        ...
        updatedCart = prevItems.filter((cartItem) => cartItem.id !== item.id);
      } else {
  ...
  return (
    <div className="flex flex-col items-center justify-between hover:scale-110 transition duration-300 ease-in gap-11 p-4 mt-10 ml-5 rounded-xl outline">
      <div>
